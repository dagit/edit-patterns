...
\jason{Correlate bug tickets with code changes}
\jason{Vary the way we grab context before doing AU}
...
\jason{In summary, we satisfied our motivating claims$\ldots$}

\jason{Fine granularity way of looking at code provides interesting
opportunities for data mining$\ldots$}
