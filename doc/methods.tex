...
\caption{The workflow of our approach\jason{This should mention weaving somewhere in the figure}}
\label{fig:workflow}
\end{center}
\end{figure}
...
\jason{the flow between these two sections is awkward. Not sure what to change.}
...
changes that have similarity greater than or equal to $\tau = 0.9$.\jason{Please improve the colors.}}
\label{fig:boolmat}
\end{center}
\end{figure}
