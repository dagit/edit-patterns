...
map the parsed code to an annotated term (or, aterm)~\cite{brand00aterm} that
represents a standardized serialization of the AST\@.  Mapping languages to a
common aterm format allows the downstream portions of our workflow to be
...
Given a weave tree, we can extract the subtrees that correspond to the three
...
with whatever concrete variable is used at that point.  The antiunification
