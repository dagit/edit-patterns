...
Using a portion of the Clojure history, varied $\tau$ from 0 to 1 with an
...
Given the low threshold, this deletion was considered to be similar following
example from {\tt PersistentHashMap.java}.
